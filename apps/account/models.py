...
class CustomUser(AbstractBaseUser, PermissionsMixin):
    ...
    phone_number = models.CharField(unique=True, max_length=12, validators=[phone_validator])
    ...
    custom_groups = models.ManyToManyField(Group, related_name='custom_users_for_groups', verbose_name=_('groups'))
    custom_user_permissions = models.ManyToManyField(Permission, related_name='custom_users_for_permissions', verbose_name=_('user permissions'))
